...
class ViewProductDetails(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # path to driver
        path = r"D:/Ruslan/Python/django 3 by example/selenuim/amazon/Drivers/chromedriver.exe"
    ...
    def test_AMZN_Search_TC_001_test_load_home_page(self):
        """User should be able to load home page"""
    ...
    def test_AMZN_Search_TC_002_test_search_for_a_term(self):
        """User should be able to perform search and get appropriate results"""
        # to load a given URL in browser window
    ...
    def test_AMZN_Search_TC_003_test_add_item_to_cart(self):
        ...
        # self.assertTrue(self.driver.find_element_by_id("attach-desktop-sideSheet").is_enabled())
        # to verify that the product was added to the cart successfully
        # self.assertTrue(self.driver.find_element_by_id("attach-added-to-cart-message").is_displayed())
        # to verify that sub cart page has loaded
    ...
    def test_AMZN_Search_TC_004_delete_item_from_cart(self):
        ...
        print("Current cart" + self.driver.find_element_by_id('nav-cart-count').text)
...
if __name__ == '__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='D:/Ruslan/Python/django 3 by example/selenuim/amazon/Reports'))